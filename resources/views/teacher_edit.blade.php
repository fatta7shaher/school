        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        <br>
                        <form action="{{route('teacher.update.{id}','test')}}" method="post">
                            {{method_field('patch')}}
                            @csrf
                            <div class="form-row">
                                <div class="col">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('Teacher_Name_ar')}}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{trans('Teacher_Name_en')}}</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label for="inputCity">{{trans('specialization')}}</label>
                                ...
                                <div class="form-group col">
                                    <label for="inputState">{{trans('Gender')}}</label>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('Joining_Date')}}</label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">{{trans('Address')}}</label>
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('Next')}}</button>
                        </form>
                    </div>
                </div>
            </div>
