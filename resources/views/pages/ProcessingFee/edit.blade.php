...
@toastr_css
@section('title')
{{__('Modify_processing_fees')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
@section('PageTitle')
{{__('Modify_processing_fees')}} : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card-body">
                ...
                <form action="{{route('ProcessingFee.update','test')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>{{__('Statement')}}: <span class="text-danger">*</span></label>
