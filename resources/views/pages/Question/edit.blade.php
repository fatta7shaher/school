...
<!-- breadcrumb -->
@section('PageTitle')
{{trans('edit_quesion')}} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('Question.update','test') }}" method="post" autocomplete="off">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="title">{{trans('the_question')}}</label>
                                    <input type="text" name="title" id="input-name" class="form-control form-control-alternative" value="{{$question->title}}">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('the_answers')}}</label>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('The_correct_answer')}}</label>
                            ...
                            <div class="form-row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Grade_id">{{trans('name_quizzes')}}: <span class="text-danger">*</span></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="Grade_id">{{trans('the_degree')}} : <span class="text-danger">*</span></label>
