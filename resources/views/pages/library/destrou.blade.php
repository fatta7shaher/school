        ...
        <form action="{{route('library.destroy','test')}}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> {{ trans('are sure of the deleting process?') }} <span class="text-danger">{{$book->title}}</span></p>
                ...
                <div class="modal-footer">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ trans('Cansel') }}</button>
                        <button type="submit"
                                class="btn btn-danger">{{ trans('submit') }}</button>
                    </div>
                </div>
            </div>
        </form>
